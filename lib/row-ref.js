(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'tinper-sparrow/src/util', 'tinper-sparrow/src/util/dateUtils', './row-util'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('tinper-sparrow/src/util'), require('tinper-sparrow/src/util/dateUtils'), require('./row-util'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.util, global.dateUtils, global.rowUtil);
        global.rowRef = mod.exports;
    }
})(this, function (exports, _util, _dateUtils, _rowUtil) {
    'use strict';

    Object.defineProperty(exports, "__esModule", {
        value: true
    });
    exports.rowRefFunObj = undefined;
    ...
    const refCombo = function (fieldName, datasource) {
        ...
        return ko.pureComputed({
            read: function () {
                ...
                if (_rowUtil.rowUtilFunObj._getField(this, fieldName)['value'] === undefined || _rowUtil.rowUtilFunObj._getField(this, fieldName)['value'] === "") return "";
                var v = _rowUtil.rowUtilFunObj._getField(this, fieldName)['value'];
    ...
    const refDate = function (fieldName, format) {
        ...
        return ko.pureComputed({
            read: function () {
                this.valueChange[fieldName]();
                this.currentRowChange();
                if (!_rowUtil.rowUtilFunObj._getField(this, fieldName)['value']) return "";
    ...
    const rowRefFunObj = exports.rowRefFunObj = {
        ref: ref,
        refMeta: refMeta,
        refCombo: refCombo,
        refDate: refDate,
