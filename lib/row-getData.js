(function (global, factory) {
    ...
    exports.rowGetDataFunObj = undefined;
            ...
            if (meta[key] && meta[key].type) {
                if (meta[key].type == 'date' || meta[key].type == 'datetime') {
                    if (key.indexOf('.') > 0) {
                        ...
                        data[key].value = _rowUtil.rowUtilFunObj._dateToUTCString(data[key].value);
                    }
    ...
    const rowGetDataFunObj = exports.rowGetDataFunObj = {
        getValue: getValue,
